...
class VdpSimpleTopo( Topo ):
    ...
    def __init__( self ): 
        # Read topology info
        ports = {1:set([1,2]), 2:set([1,2,3]), 3:set([1,2,3]), \
                 4:set([2,3,4]), 5:set([1,2,3,4]), 6:set([1,4]), 7:set([1,3,4])}
        links = set([(100001,300003),(100002,200003), (300002,400004),(200001,400003),\
                     (200002,500004),(400002,500001), (500003,600004),(500002,700004), (600001,700003)])
        switches = ports.keys()
